const aboutMeText = `Bonjour, je m'appelle Nathan DESMEE. Je suis étudiant à l'université de Lille où je termine actuellement une formation en 3ème année de BUT informatique en parcours développement et réalisation d'applications. A l'issue de la validation prochaine de mon diplôme en juillet 2025, je souhaite intégrer, dès septembre 2025, un cursus ingénieur en apprentissage spécialisé en data et IA. En effet, je pense que l'IA peut jouer un rôle majeur dans l'évolution de l'humanité notamment dans le domaine de la santé, du confort et de l'écologie. Ainsi, j'aimerais contribuer au développement de cette technologie qui va marquer un tournant dans l'histoire.`;
const aboutFormationText = `                                                                                        Grâce à ma formation, j'ai pu acquérir de nombreuses compétences informatiques et réaliser de nombreux projets. En binôme, j'ai notamment créé une base de données complète contenant des informations sur les jeux olympiques. J'ai ensuite analysé ces données pour produire des graphiques statistiques. Ce fut mon premier pas vers la gestion et l'analyse de données. J'ai également pu réaliser, de nouveau en binôme, un site web permettant de prendre des rendez-vous ce qui m'a permis d'apprendre de nouvelles compétences dans divers domaines. J'ai eu également l'opportunité de travailler en Norvège à la Norwegian University of Science and Technology dans le cadre de mon stage de fin de 2e année de BUT. Durant ce stage, j'ai pu parfaire mon anglais et en apprendre plus sur les technologies du domaine du visuel. Finalement, je réalise actuellement un stage de 14 semaines dans l'entreprise Michelin de Clermont-Ferrand où je perfectionne mes compétences en utilisation et analyse de données.`;
